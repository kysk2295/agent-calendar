...
const ENV_DEFINITIONS = [
  ...
  { env: 'HERMES_TELEGRAM_BOT_TOKEN_BIZCONSULTANT', path: 'telegram.botTokens.bizconsultant' },
  { env: 'HERMES_TELEGRAM_BOT_TOKEN_STOCKAGENT', path: 'telegram.botTokens.stockagent' },
  { env: 'HERMES_TELEGRAM_BOT_TOKEN_UNIPORTPM', path: 'telegram.botTokens.uniportpm' },
  { env: 'HERMES_TELEGRAM_BOT_TOKEN_WIKICURATOR', path: 'telegram.botTokens.wikicurator' },
  { env: 'HERMES_TELEGRAM_INGRESS_MODE', path: 'telegram.ingressMode' },

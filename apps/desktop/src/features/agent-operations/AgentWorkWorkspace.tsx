    ...
    <div className="agent-control-shell">
      ...
      <div className="agent-control-room">
        ...
        <p className="agent-control-lede">{delegationMode === 'mode_b'
          ...
          : <><strong>Mode A · 목표만으로 위임</strong><span>할 일을 적으면 담당 에이전트가 자동으로 배정됩니다.</span></>}
        </p>
